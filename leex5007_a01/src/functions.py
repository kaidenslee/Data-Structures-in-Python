...
def list_subtraction(minuend, subtrahend):
    ...
    # this one is wrong dont use remove
    for y in range(len(minuend)):
        for x in range(len(subtrahend)):
            if subtrahend[x] in minuend:
...
def dsmvwl(string):
    """
    -------------------------------------------------------
    Disemvowels a string. out contains all the characters in string
