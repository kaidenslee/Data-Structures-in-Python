...
def get_food():
    ...
    vegetarian = str(input("Vegetarian (Y/N): "))
    ...
    # im getting input and creating the object. when i return the object, then its using the __str__ method to format it properly
...
def write_foods(file_variable, foods):
    ...
    s = ""
    for i in foods:
        s += ("{}|{}|{}|{}\n".format(i.name, i.origin,
              i.is_vegetarian == True, i.calories))
