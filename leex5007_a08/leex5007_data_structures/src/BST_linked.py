...
class BST:
    ...
    def _eq_aux(self, node1, node2):
        ...
        if node1 is None and node2 is None:
            ...
            if node1._value == node2._value and node1._height == node2._height:
                # equals is true only if both cases are true. goes through both to get answer.
                equals = self._eq_aux(node1._left, node2._left) and self._eq_aux(
    ...
    def max(self):
        ...
        # write down explanation for max and min of bst
        current = self._root
        flag = False
    ...
    def is_valid(self):
        ...
        ---------------------------------------------------------
        """
        # height is from node._height to a leaf node
    ...
    def _is_valid_aux(self, node):
        if node is None:
            ...
            valid = self._is_valid_aux(
                node._left) and self._is_valid_aux(node._right)
