...
class List:
    ...
    def _linear_search(self, key):
        ...
        while found is False and i < len(self._values):
    ...
    def clean(self):
        ...
        for i in self._values:
            if i not in cleaned._values:
                cleaned.append(i)

        self._values = cleaned._values
    ...
    def intersection(self, source1, source2):
        ...
        for i in source1._values:
            for x in source2._values:
                if i == x and i not in self._values:
    ...
    def union(self, source1, source2):
        ...
        """
        for i in source1._values:
            if i in source1._values and i in source2._values:
                self._values.append(i)
